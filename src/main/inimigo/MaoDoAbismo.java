...
public class MaoDoAbismo  extends Entidade{

    PainelDoJogo painel;

    public MaoDoAbismo(PainelDoJogo painel) {
        super(painel);
        this.painel = painel;
    ...
    public void getImagem(){
        cima1 = setup("/res/inimigo/maoDoAbismo1", painel.tamanhoDoTile, painel.tamanhoDoTile);
        cima2 = setup("/res/inimigo/maoDoAbismo2", painel.tamanhoDoTile, painel.tamanhoDoTile);
        baixo1 = setup("/res/inimigo/maoDoAbismo1", painel.tamanhoDoTile, painel.tamanhoDoTile);
        baixo2 = setup("/res/inimigo/maoDoAbismo2", painel.tamanhoDoTile, painel.tamanhoDoTile);
        esquerda1 = setup("/res/inimigo/maoDoAbismo1", painel.tamanhoDoTile, painel.tamanhoDoTile);
        esquerda2 = setup("/res/inimigo/maoDoAbismo2", painel.tamanhoDoTile, painel.tamanhoDoTile);
        direita1 = setup("/res/inimigo/maoDoAbismo1", painel.tamanhoDoTile, painel.tamanhoDoTile);
        direita2 = setup("/res/inimigo/maoDoAbismo2", painel.tamanhoDoTile, painel.tamanhoDoTile);
    }
